...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function nextSlide(right, left, width, slide, slidesField, slidesCount) {
  ...
  nextSlide(advantagesNext, advantagesPrevious, advantagesWidth,
    advantagesCurrent, advantagesSlidesField, 4);
  nextSlide(techNext, techPrevious, techWidth, techCurrent, techSlidesField, 2);

  nextSlide(featuresNext, featuresPrevious, featuresWidth,

    featuresCurrent, featuresSlidesField, 3);

  function previousSlide(left, right, width, slide, slidesField, slidesCount) {
  ...
  previousSlide(advantagesPrevious, advantagesNext, advantagesWidth,
    advantagesCurrent, advantagesSlidesField, 4);

  previousSlide(techPrevious, techNext, techWidth,

    techCurrent, techSlidesField, 2);

  previousSlide(featuresPrevious, featuresNext, featuresWidth,
    featuresCurrent, featuresSlidesField, 3);
});
